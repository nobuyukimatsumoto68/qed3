...
int main(int argc, char* argv[]){
  ...
  // const int kmax=320;   // 2026-07-03 MASSLESS strong-coupling study (gsq=12,16): L=4 cap 320 (NM)
  const int kmax=600;   // 2026-07-10 MASSLESS study L=4 cap bumped 320 -> 600 (NM)
