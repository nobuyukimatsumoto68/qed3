...
## REMOTE status (auto-updated 2026-07-10 by check-ensembles sync)
...
Last sync: `fermilab_dirs.txt` +0 new dir(s); `fermilab_ncfg_claude.txt` regenerated; `jj_ensembles_claude.txt` 54 loc=N row(s) refreshed, +36 new row(s).
