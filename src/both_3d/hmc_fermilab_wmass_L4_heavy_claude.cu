...
int main(int argc, char* argv[]){
  ...
  // const int kmax=320;
  // 2026-07-03: recapped heavy L4 320 -> 120 (NM). Heavy L4 was @93-109; 120 is a near-finish target.
  const int kmax=120;   // L=4 max conf (recapped 200 -> 120 on 2026-06-23; heavy L4 -> 120 on 2026-07-03)
