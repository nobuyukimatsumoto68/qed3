#!/usr/bin/gnuplot
# Plot H evolution + Sf force norms + eta/phi ratio for crash trajectory k=1272.
# Data files:
#   H_evolution_k1272_claude.dat    -- cols: t type outer half inner_step Sg Sf_cached Smom H_approx
#   Sf_force_norms_k1272_claude.dat -- cols: t kick_idx pf_idx label L2_norm Linf_norm
#   eta_phi_k1272_claude.dat        -- cols: t kick_idx outer phase ipf eta_phi_ratio

set terminal pngcairo size 1400,2100 font "Sans,12"
set output "H_evolution_k1272_claude.png"

dat  = "H_evolution_k1272_claude.dat"
fdat = "Sf_force_norms_k1272_claude.dat"
edat = "eta_phi_k1272_claude.dat"
...
set title "H evolution during crash trajectory k=1272  (dH = -9.25)"
set key top right

set xrange [-10:1015]
set yrange [10947:10966]

# Vertical dashed lines at kick positions
set style line 10 lc rgb "#aaaaaa" lw 1 dt 2
set for [t = 0:1010:101] arrow from t, graph 0 to t, graph 1 nohead ls 10

set label 1 "outer 0"  at  50, 10964 center font "Sans,10" tc rgb "#444444"
set label 2 "outer 1"  at 252, 10964 center font "Sans,10" tc rgb "#444444"
set label 3 "outer 2"  at 454, 10964 center font "Sans,10" tc rgb "#444444"
set label 4 "outer 3"  at 656, 10964 center font "Sans,10" tc rgb "#444444"
set label 5 "outer 4"  at 858, 10964 center font "Sans,10" tc rgb "#444444"
set label 6 "half 0|1" at 151, 10963 center font "Sans,9"  tc rgb "#888888"
set label 7 "half 0|1" at 353, 10963 center font "Sans,9"  tc rgb "#888888"
set label 8 "half 0|1" at 555, 10963 center font "Sans,9"  tc rgb "#888888"
set label 9 "half 0|1" at 757, 10963 center font "Sans,9"  tc rgb "#888888"
set label 10 "half 0|1" at 959, 10963 center font "Sans,9" tc rgb "#888888"

set arrow 1 from 960, 10958.5 to 1010, 10950.5 lw 2 lc rgb "#cc0000" filled
set label 11 "dH = -8.67" at 940, 10957 right font "Sans,11,Bold" tc rgb "#cc0000"
