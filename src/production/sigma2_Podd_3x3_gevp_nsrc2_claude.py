...
def main():
    ...
    ax.set_title(r"P- 3x3 FP$\times$geom reb%d@%d T0=%d  %s L1 %dcfg" % (NKEEP, REBT, T0, tag, ncfg), fontsize=11)
    ax.legend(fontsize=9, loc="upper right")
    ax.grid(alpha=0.3)
    fig.tight_layout()
    os.makedirs("figs", exist_ok=True)
    out = "figs/sigma2_Podd_3x3_reb%d_T0%d_%s_nsrc2_claude.png" % (NKEEP, T0, tag)
